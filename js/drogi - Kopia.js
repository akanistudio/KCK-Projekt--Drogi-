...
function wyczysc_parse()
{
  ...
  ctx2.clearRect(0, 0, map2.width, map2.height); 
}
...
function rysuj()
{
  ...
  document.getElementById("opisz").disabled = false;
  document.getElementById("przerysuj").disabled = false;
}
function opisz()
{
  wyczysc_opis();
  ...
  document.getElementById("opisz").disabled = true;
}
...
function przerysuj()
{
  ...
  ctx2.beginPath();
  parse();
  document.getElementById("przerysuj").disabled = true;
}
